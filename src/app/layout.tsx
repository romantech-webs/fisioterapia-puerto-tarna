  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisioterapia-puerto-tarna";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisioterapia Puerto Tarna"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisioterapia-puerto-tarna"
          data-primary-color="#d6982c"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="fisioterapia-puerto-tarna";
